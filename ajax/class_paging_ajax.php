    ...
    class paging_ajax
    {
        ...
        public function Load()
        {
    		...
    		if($hien_phantrang==1)
            {
                ...
                {
    				if($this->cur_page == $i) $msg .= "<li p='$i' class='actived'><a>{$i}</a></li>";
                ...
                {
                	$nex = $this->cur_page + 1;
                	$msg .= "<li p='$nex' class='active'>"._trangke."</li>";
                }
                else if($next_btn)
                {
                	$msg .= "<li class='$this->class_inactive'>"._trangke."</li>";
                }
