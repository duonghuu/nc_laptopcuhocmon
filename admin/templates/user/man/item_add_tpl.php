...
<div class="pagetitle">
	<h1><?php if ($_REQUEST['act']=="edit") echo 'Cập nhật người dùng'; else echo 'Thêm mới người dùng'; ?></h1>
</div>
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="widgetcontent bordered shadowed nopadding">
					<form name="frm" method="post" action="index.php?com=user&act=save" enctype="multipart/form-data" class="stdform stdform2">
						<p><label>Tài khoản <span class="require">*</span></label><span class="field"><input type="text" name="username" id="username" value="<?=$item['username']?>" class="input" <?php if($_GET['act'] == "edit") echo "readonly"; ?> required="" placeholder="Tài khoản"/></span></p>
