		...
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="widgetcontent bordered shadowed nopadding">
					<form name="frm" method="post" action="index.php?com=tinhthanh_quanhuyen&act=save_cat" enctype="multipart/form-data" class="stdform stdform2">
					    <p><label>Danh mục tỉnh thành:</label><span class="field"><?=get_main_list();?></span></p>
						...
						<p class="stdformbutton">
							...
							<button type="button" onclick="javascript:window.location='index.php?com=tinhthanh_quanhuyen&act=man_cat'" class="btn"><span class="iconfa-off"></span> Thoát</button>
						</p>	
					</form>
				</div>
			</div>
