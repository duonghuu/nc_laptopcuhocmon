<?php  
    ...
    $ttnb = get_result_array("SELECT ten$lang, mota$lang, tenkhongdau, ngaytao, id, photo FROM table_news WHERE hienthi=1 AND type='tin-tuc' AND noibat>0 ORDER BY stt,id DESC");
